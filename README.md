## ATLAS TileCal Xilinx Virtual Cable Server for Raspberry Pi

This project is a modification of https://github.com/kholia.
...
The pin mappings is changed depending on optional flags of `xvcpi`: -m for minidrawer selection (1 - 4) and -s for side selection (1 for side a or 2 for side b)
...
Start **tile_xvcpi** on the Raspberry Pi. An optional -v flag can be used for verbose output.

```
sudo ./tile_xvcpi -m 1 -s 1
```
...
Upstream: https://github.com/kholia, https://github.com/strongleg/xvcpi and https://github.com/derekmulcahy/xvcpi projects.
